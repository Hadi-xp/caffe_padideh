...
glasseIcon.addEventListener("click",()=>{
    ...
    glasseBox.style.display = "block";
    previusBox = glasseBox;
})
// majoon
...
majoonIcon.addEventListener("click",()=>{
    ...
    majoonBox.style.display = "block";
    previusBox = majoonBox;
})
// icecream
...
icecreamIcon.addEventListener("click",()=>{
    ...
    icecreamBox.style.display = "block";
    previusBox = icecreamBox;
})
// burger
...
icepackIcon.addEventListener("click",()=>{
    ...
    icepackBox.style.display = "block";
    previusBox = icepackBox;
})
// mocktel
...
mocktelIcon.addEventListener("click",()=>{
    ...
    mocktelBox.style.display = "block";
...
hotdogIcon.addEventListener("click",()=>{
    ...
    hotdogBox.style.display = "block";
    previusBox = hotdogBox;
})
// hotDrink
...
hotDrinkIcon.addEventListener("click",()=>{
    ...
    hotDrinkBox.style.display = "block";
    previusBox = hotDrinkBox;
})
// coldDrink
...
coldDrinkIcon.addEventListener("click",()=>{
    ...
    coldDrinkBox.style.display = "block";
    previusBox = coldDrinkBox;
})
// milkshake
